...
export default function NutrientList(props) {
	const nutrients = props.nutrients.map((nutrient, index) => {
	...
	const addNewNutrientButton = (
		<IconButton icon='pi pi-plus' onClick={setDisplayAddNewNutrient.bind(null, true)} />
	)
	...
	return (
		<Fragment>
			<Header
				title='Nutrient List'
				content={auth.isAdminLoggedIn ? addNewNutrientButton : null}
			/>
